...
Source0  : https://github.com/pygobject/pycairo/releases/download/v1.26.0/pycairo-1.26.0.tar.gz
Source1  : https://github.com/pygobject/pycairo/releases/download/v1.26.0/pycairo-1.26.0.tar.gz.sig
...
%prep
%setup -q -n pycairo-1.26.0
cd %{_builddir}/pycairo-1.26.0
%patch -P 1 -p1
pushd ..
cp -a pycairo-1.26.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707756558
