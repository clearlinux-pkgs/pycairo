...
Source0  : https://github.com/pygobject/pycairo/releases/download/v1.25.1/pycairo-1.25.1.tar.gz
Source1  : https://github.com/pygobject/pycairo/releases/download/v1.25.1/pycairo-1.25.1.tar.gz.sig
...
%prep
%setup -q -n pycairo-1.25.1
cd %{_builddir}/pycairo-1.25.1
%patch -P 1 -p1
pushd ..
cp -a pycairo-1.25.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1698018369
